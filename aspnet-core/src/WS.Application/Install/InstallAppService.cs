...
namespace WS.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : WSAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<WSDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{WSConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{WSConsts.ConnectionStringName}", constring);
        }
