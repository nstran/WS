...
using WS.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace WS.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : WSAppServiceBase, IDashboardCustomizationAppService
    {
