...
using WS.Authentication.TwoFactor;
using WS.Chat;
...
using WS.Web.DashboardCustomization;
...
namespace WS.Web
{
    ...
    public class WSWebCoreModule : AbpModule
    {
        ...
        public WSWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(WSWebCoreModule).Assembly);
        }
