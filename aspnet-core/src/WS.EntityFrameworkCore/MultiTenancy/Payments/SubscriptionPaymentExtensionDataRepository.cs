...
{
    public class SubscriptionPaymentExtensionDataRepository : WSRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<WSDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
